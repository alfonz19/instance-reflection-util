...
public interface Initializer {
    boolean canProvideValueFor(Class<?> type, Type genericType, PathNode pathNode);
    Object getValue(Class<?> type, Type genericType, PathNode pathNode, ClassTreeTraverserContext context);
